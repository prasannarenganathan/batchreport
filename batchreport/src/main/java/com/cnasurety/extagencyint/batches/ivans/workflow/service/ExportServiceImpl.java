...
import com.cnasurety.extagencyint.batches.ivans.workflow.dto.KeyValueDTO;
import com.cnasurety.extagencyint.batches.ivans.workflow.repository.DocumentRepository;
import com.cnasurety.extagencyint.batches.ivans.workflow.repository.EventAuditRepository;
import com.cnasurety.extagencyint.batches.ivans.workflow.repository.KeyValueRepository;
import com.cnasurety.extagencyint.batches.ivans.workflow.repository.NotificationRepository;
import com.cnasurety.extagencyint.batches.ivans.workflow.repository.PackageRepository;
        ...
        try {
            ...
            keyValues.forEach(keyValue -> {
                ...
                if (keyValue.getKeyValuePairTypeCode().equals("NOTIFICATION_TBL")) {
                    ...
                    keyValueDTO.setForiegnKeyId(packageRepository.findPackageIdByKeyValuePairId(keyValue.getKeyValuePairId()));
                } else { // (keyValue.getKeyValuePairTypeCode().equals("DOCUMENT_TBL")) {
                    keyValueDTO
                            .setForiegnKeyId(documentRepository.findDocumentIdByKeyValuePairId(keyValue.getKeyValuePairId()));
                }
